...
The AKShare CLI currently records daily frequency and the trade-calendar endpoint as compatibility parameters. Different stock scopes, date ranges, adjustment policies, providers, contracts, or compatibility parameters produce different series keys.
