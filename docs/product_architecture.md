...
| Market Cockpit | Selected-universe breadth, participation, risk, provenance, completeness, and optional separately selected provider-attributed benchmark context. | v0.4A foundation implemented; v0.4B benchmark context in review; sectors, style, valuation, and crowding unsupported |
