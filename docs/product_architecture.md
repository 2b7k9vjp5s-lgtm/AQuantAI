...
| Industry Alpha | Stage 1 industry mapping and Stage 2 company research with evidence and cutoff dates. | v0.5A-v0.5C merged; v0.6A adds exact-membership company research; v0.6B adds bounded expectation and valuation-observation snapshots; scoring, recommendations, and trading unsupported |
| Stock Research | Company role, beneficiary relationship, bounded financial-transmission hypotheses, expectations, valuation, catalysts, and risks. | v0.6A-v0.6B foundations implemented; no target prices, fair values, expected returns, scoring, recommendations, or later judgment workflows |
