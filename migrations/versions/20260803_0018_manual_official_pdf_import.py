...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Uuid(), primary_key=True),
        sa.Column("review_session_id", sa.Uuid(), sa.ForeignKey("local_document_review_sessions.id", ondelete="RESTRICT"), nullable=False),
        sa.Column("source_review_revision_id", sa.Uuid(), sa.ForeignKey("local_document_review_revisions.id", ondelete="RESTRICT"), nullable=False),
        sa.Column("accepted_review_revision_id", sa.Uuid(), sa.ForeignKey("local_document_review_revisions.id", ondelete="RESTRICT"), nullable=False),
        sa.Column("target_research_case_id", sa.Uuid(), sa.ForeignKey("research_cases.id", ondelete="RESTRICT"), nullable=False),
        ...
        sa.UniqueConstraint("source_review_revision_id", name="uq_local_document_receipt_source"),
        sa.UniqueConstraint("accepted_review_revision_id", name="uq_local_document_receipt_accepted"),
        sa.UniqueConstraint("request_fingerprint_sha256", name="uq_local_document_receipt_request"),
    ...
    op.create_table(
        ...
        sa.Column("claim_revision_id", sa.Uuid(), sa.ForeignKey("claim_revisions.id", ondelete="RESTRICT"), nullable=False),
        ...
        sa.UniqueConstraint("evidence_item_id", name="uq_local_document_acceptance_evidence"),
        sa.UniqueConstraint("claim_revision_id", name="uq_local_document_acceptance_claim_revision"),
    )
