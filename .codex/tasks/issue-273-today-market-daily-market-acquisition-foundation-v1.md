...
Subsequent commits modify only this task snapshot. Current-head CI is authoritative from PR #274 / GitHub Actions. M4–M6 remain pending, so no fixed-head implementation review is requested yet.
